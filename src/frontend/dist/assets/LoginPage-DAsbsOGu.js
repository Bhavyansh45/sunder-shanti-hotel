import { r as reactExports, j as jsxRuntimeExports, u as useAuth, a as useNavigate, L as LogoLight, B as Button, b as LoaderCircle } from "./index-DkGMr7Y2.js";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            style: {
              background: "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(0.65 0.14 70 / 0.12) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 80% 100%, oklch(0.52 0.12 160 / 0.08) 0%, transparent 60%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col items-center justify-center px-4 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogoLight, { size: "xl", variant: "full", className: "justify-center" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-lg", "aria-hidden": "true", children: "✦" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-8 shadow-elevated space-y-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground tracking-tight", children: "Staff Portal" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Sign in to access the hotel management system" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isLoggingIn ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          ...
                          fill: "currentColor",
                          "aria-hidden": "true",
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z" })
                        }
                      ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center leading-relaxed", children: "Internet Identity provides secure, privacy-preserving authentication. Only authorized hotel staff can access this system." })
              ] })
            ]
          }
        ) }),
