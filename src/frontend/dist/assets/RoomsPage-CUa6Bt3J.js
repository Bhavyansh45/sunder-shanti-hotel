import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, k as useComposedRefs, l as cn, m as reactDomExports, e as useRooms, n as useIsAdmin, R as RoomStatus, B as Button, h as BedDouble, o as ue, i as RoomType, b as LoaderCircle } from "./index-DkGMr7Y2.js";
import { P as Presence, a as Primitive, u as useControllableState, c as composeEventHandlers, b as createContextScope, d as useCallbackRef, e as useLayoutEffect2, f as useId, g as createSlot, h as createSlottable } from "./index-DDLz35mE.js";
...
import { u as useDirection, c as createCollection } from "./index-CKEwVOdo.js";
import { P as Portal$2, h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./alert-dialog-CW2Sxwww.js";
...
import { P as PageHeader } from "./PageHeader-DWaItQZG.js";
import { A as ALL_ROOM_TYPES, R as RoomTypeLabel } from "./RoomTypeLabel-D-zFrM3d.js";
import { S as StatusBadge } from "./StatusBadge-C6WwwJE-.js";
import { u as useDeleteRoom, a as useUpdateRoom, b as useCreateRoom } from "./mutations-CwTLAjvd.js";
...
function RoomFormSheet({ open, onOpenChange, editRoom }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (isEdit && editRoom) {
        ...
        ue.success("Room added successfully");
      }
      onOpenChange(false);
    } catch (err) {
  ...
  const statusOptions = isEdit ? [RoomStatus.Available, RoomStatus.Maintenance, RoomStatus.Occupied] : [RoomStatus.Available, RoomStatus.Maintenance];
  const statusLabels = {
    [RoomStatus.Available]: "Available",
    [RoomStatus.Occupied]: "Occupied",
    [RoomStatus.Maintenance]: "Maintenance"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { className: "w-full sm:max-w-md overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "font-display", children: isEdit ? `Edit Room ${editRoom == null ? void 0 : editRoom.number}` : "Add New Room" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { children: isEdit ? "Update room details below." : "Fill in the details to add a new room." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "mt-6 space-y-5 px-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "room-number", children: "Room Number" }),
        isEdit ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: editRoom == null ? void 0 : editRoom.number
          }
          ...
          errors.number && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.number })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "room-type", children: "Room Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "room-type", "data-ocid": "room-type-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ALL_ROOM_TYPES.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value, children: label }, value)) })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "room-price", children: "Price per Day" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-sm font-medium select-none", children: "₹" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "room-price",
        ...
        errors.pricePerDay && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.pricePerDay })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "room-status", children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: form.status,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "room-status", "data-ocid": "room-status-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: statusOptions.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: statusLabels[s] }, s)) })
            ]
          }
        ),
        !isEdit && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "New rooms cannot start as Occupied." })
      ] }),
...
function RoomsPage() {
  ...
  const filtered = reactExports.useMemo(() => {
    return rooms.filter((room) => {
      const matchSearch = !searchQuery || room.number.toLowerCase().includes(searchQuery.toLowerCase());
  ...
  async function handleDelete() {
    ...
    try {
      ...
      ue.success(`Room ${deleteTarget.number} deleted`);
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "rooms-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 bg-card border-b border-border flex flex-wrap gap-3 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterStatus, onValueChange: setFilterStatus, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-40", "data-ocid": "filter-status-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Statuses" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Statuses" }),
          Object.values(RoomStatus).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: statusLabel[s] }, s))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterType, onValueChange: setFilterType, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-40", "data-ocid": "filter-type-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Types" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Types" }),
          ALL_ROOM_TYPES.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value, children: label }, value))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
    ...
    isAdmin && selectedIds.size > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-2.5 bg-primary/5 border-b border-primary/20 flex items-center gap-3 text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border overflow-hidden bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableSkeleton, { rows: 6, cols: 5 }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BedDouble, { size: 32 }),
        title: rooms.length === 0 ? "No rooms yet" : "No rooms match your filters",
        description: rooms.length === 0 ? "Add your first room to get started." : "Try adjusting your search or filter criteria.",
        action: rooms.length === 0 && isAdmin ? {
          label: "Add First Room",
          onClick: openAddSheet,
          dataOcid: "empty-add-room-btn"
        } : void 0
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border overflow-hidden bg-card shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40 hover:bg-muted/40", children: [
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-10 pl-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Checkbox,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-foreground", children: "Room #" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-foreground", children: "Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "font-semibold text-foreground text-right", children: "Price / Day" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filtered.map((room) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableRow,
          {
            ...
            children: [
              isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "pl-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
                  checked: isSelected,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-semibold text-foreground", children: room.number }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: room.status }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end gap-1.5", children: isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Edit room" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      "aria-label": isOccupied ? "Cannot delete occupied room" : void 0,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          size: "icon",
                          ...
                          onClick: () => !isOccupied && confirmDelete(room),
                          disabled: isOccupied,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: isOccupied ? "Cannot delete occupied room" : "Delete room" })
                ] })
              ] }) }) })
            ]
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
      {
        ...
        title: `Delete Room ${(deleteTarget == null ? void 0 : deleteTarget.number) ?? ""}?`,
